...
using DG.Tweening;
public class MapTranslateTwo : MonoBehaviour
{
    private static MapTranslateTwo _instance;
    public static MapTranslateTwo Instance
    { get { return _instance; } }
    void Awake()
    {
        _instance = this;
        modelPlaceObj = gameObject.FindComponent<Transform>("ModelPlace").gameObject;
        var mapPath = MapTableTwo.Instance[SaveIndexMgr.Instance.CurindexMapTwo + 1].MapPath;
