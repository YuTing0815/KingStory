...
using DG.Tweening;
public class MapTranslateThree : MonoBehaviour
{
    private static MapTranslateThree _instance;
    public static MapTranslateThree Instance
    { get { return _instance; } }
    void Awake()
    {
        _instance = this;
        modelPlaceObj = gameObject.FindComponent<Transform>("ModelPlace").gameObject;
        var mapPath = MapTableThree.Instance[SaveIndexMgr.Instance.CurindexMapThree + 1].MapPath;
