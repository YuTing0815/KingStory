...
using DG.Tweening;
public class MapTranslateFour : MonoBehaviour
{
    private static MapTranslateFour _instance;
    public static MapTranslateFour Instance
    { get { return _instance; } }
    void Awake()
    {
        _instance = this;
        modelPlaceObj = gameObject.FindComponent<Transform>("ModelPlace").gameObject;
        var mapPath = MapTableFour.Instance[SaveIndexMgr.Instance.CurindexMapFour + 1].MapPath;
