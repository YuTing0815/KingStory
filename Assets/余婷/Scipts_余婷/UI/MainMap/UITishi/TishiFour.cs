...
public class TishiFour
{
    ...
    public void Init(int index)
    {
        ...
        if (num == 0)
        {
            ...
            else
            {
                ...
                _mapName.text = MapTableFour.Instance[index + 1].Name;
    ...
    public void DontUse()
    {
        foreach (var item in WYFour.Instance.AllPointList)
        {
    ...
    private void OnBtnGoToClick(int mapIndex,GameObject obj)
    {
       // CanUse();
        ResMgr.Instance.Release(obj);
        //Time.timeScale = 1;
        SaveIndexMgr.Instance.SaveMapFour(mapIndex);
        SceneManager.LoadScene("Scenes/GamePlaying4");
