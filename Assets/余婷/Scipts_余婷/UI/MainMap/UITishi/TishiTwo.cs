...
public class TishiTwo
{
    ...
    public void Init(int index)
    {
        ...
        if (num == 0)
        {
            ...
            else
            {
                ...
                _mapName.text = MapTableTwo.Instance[index + 1].Name;
    ...
    public void DontUse()
    {
        foreach (var item in WYTwo.Instance.AllPointList)
        {
    ...
    private void OnBtnGoToClick(int mapIndex,GameObject obj)
    {
       // CanUse();
        ResMgr.Instance.Release(obj);
        //Time.timeScale = 1;
        SaveIndexMgr.Instance.SaveMapTwo(mapIndex);
        SceneManager.LoadScene("Scenes/GamePlaying2");
