...
public class TishiThree
{
    ...
    public void Init(int index)
    {
        ...
        if (num == 0)
        {
            ...
            else
            {
                ...
                _mapName.text = MapTableThree.Instance[index + 1].Name;
    ...
    public void DontUse()
    {
        foreach (var item in WYThree.Instance.AllPointList)
        {
    ...
    private void OnBtnGoToClick(int mapIndex,GameObject obj)
    {
       // CanUse();
        ...
        SceneManager.LoadScene("Scenes/GamePlaying3");
